...
const Artists: React.FC = () => {
  ...
  const artists: ArtistWithPortfolio[] = [
    ...
    },
    {
      ...
      bio: "Sarah traz cores vibrantes e linhas ousadas. Seu estilo Neo Tradicional combina o clássico com o moderno.",
      styles: ["Neo Tradicional", "Colorido", "Botânico"],
      img: "https://images.unsplash.com/photo-1596204368623-2895f543666f?auto=format&fit=crop&q=80&w=800",
      rating: 5.0,
      ratingCount: 1450,
      portfolio: [
        {
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1574158622682-e40e69881006?auto=format&fit=crop&q=80&w=800",
      rating: 4.2,
      ratingCount: 920,
      portfolio: [
        {
