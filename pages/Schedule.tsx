...
const Schedule: React.FC = () => {
    ...
    // --- Calendar Handler ---
    const handleDateSelect = (_day: number, _displayStr: string, isoDate: string) => {
                        ...
                        <form onSubmit={confirmReschedule} className="flex flex-col h-full">
                            ...
                            <div className="p-6 overflow-y-auto space-y-8 flex-1">
                                ...
                                <div className="relative" ref={calendarRef}>
                                    ...
                                    {/* Floating Calendar */}
                                    {isCalendarOpen && (
                                        <div className="absolute top-full left-0 mt-2 z-20 w-full max-w-[280px] animate-fade-in">
                                            <Calendar
                                                viewDate={viewDate}
