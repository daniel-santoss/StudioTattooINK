...
import { criarSolicitacao } from '@/features/booking/actions/criarSolicitacao';
...
const Booking: React.FC<{ artists: BookingArtist[] }> = ({ artists }) => {
    ...
    useEffect(() => {
        ...
        if (artistParam && artists.find(a => a.id === artistParam)) {
    ...
    // Envia a solicitação (persiste de verdade) e mostra a tela de sucesso (passo 4).
                            ...
                            <div className="p-6 border-b border-zinc-800 flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-zinc-500 text-xs uppercase tracking-widest font-black mt-1">{previewArtist.role}</p>
                                    </div>
                                </div>
                                <button
