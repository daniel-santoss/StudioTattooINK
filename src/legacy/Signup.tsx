        ...
        <div className="relative" ref={wrapperRef}>
            <div className="relative">
                <input
                    ...
                    className={`w-full bg-background-dark border border-border-dark rounded-lg p-2.5 pr-8 text-white focus:border-primary text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed ${isOpen ? 'border-primary border-2' : ''}`}
                />
            ...
            <div className="w-full max-w-2xl bg-surface-dark border border-border-dark rounded-2xl p-8 shadow-2xl relative z-10 animate-fade-in my-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`w-full bg-background-dark border rounded-lg p-2.5 text-white transition-colors ${passwordsMismatch
                ...
                <div className="mt-6 text-center pt-6 border-t border-border-dark">
                    <p className="text-xs text-text-muted">
                        Já tem uma conta? <Link href="/login" className="text-white hover:text-primary transition-colors font-bold ml-1 underline">Faça Login</Link>
                    </p>
                </div>
            </div>
        </div>
