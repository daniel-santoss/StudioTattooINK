...
const LandingContent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (scrollTo) {
      ...
      // Clean the URL without scrollTo param
      ...
      <section id="home" className="relative min-h-[80vh] pt-24 pb-16 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/book"
              className="px-8 py-4 bg-primary hover:bg-primary-hover text-white font-bold text-sm uppercase tracking-widest rounded shadow-[0_0_30px_rgba(212,17,50,0.4)] hover:shadow-[0_0_40px_rgba(212,17,50,0.6)] transition-all transform inline-block text-center"
            >
              Agendar Horário
            </Link>
            <Link
      ...
      <section id="gallery" className="py-20 bg-black border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            ...
            <Link href="/gallery" className="flex items-center gap-2 text-white hover:text-primary font-bold uppercase text-xs tracking-widest transition-colors">
        ...
        >
          ...
          >
            ...
            <div className="w-full md:w-1/2 bg-black flex items-center justify-center relative">
              <img src={selectedImage.img} alt="Detalhe" className="w-full h-full object-cover max-h-[60vh] md:max-h-[80vh]" />
